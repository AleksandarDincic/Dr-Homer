...
public class CompositeOperationNameDialog extends EditorDialog {
	private TextField nameField;
	private Button addButton;

	public CompositeOperationNameDialog(MainWindow owner) {
		super(owner, "Add composite operation", 480, 120);
	}
	...
	protected void addComponents() {
		...
		Label dialogLabel = new Label("Enter new composite operation name:");
	...
	protected void addListeners() {
		...
		addButton.addActionListener(e -> {
			try {
				mwOwner.addCompositeOperation(nameField.getText());
				setVisible(false);
